...
<body>
  <div class="wrapper">
    <h2>Forgot Password</h2> <form action="{{ route('changepassword') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="input-box">
        ...
        {{-- <div class="input-box">
        <input type="text" maxlength="50" name="Name" value="{{Session::get('otp')}}" required>
      </div>
      --}}
      <div class="input-box">
